...
export function ProductCard({
  ...
  const visibleDescription =
    canCollapse && !expanded ? previewDescription(description) : description

  return (
    <article
      className={`product-card${selected ? ' product-card--selected' : ''}${
        expanded ? ' product-card--expanded' : ''
      }`}
    ...
    >
      ...
      <div className="product-card__body">
        ...
        {description ? (
          <p
            id={descId}
            className={`product-card__desc${expanded ? ' product-card__desc--expanded' : ''}`}
          >
            {visibleDescription}
            {canCollapse ? (
              <>
                ...
                >
                  {expanded ? meta.showLessLabel : meta.readMoreLabel}
                </button>
              </>
